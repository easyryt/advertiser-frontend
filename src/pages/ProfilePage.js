...
const ProfilePage = () => {
  ...
  const handleNameUpdate = async (e) => {
    ...
    try {
      ...
      await axios.put(
        "https://advertiserappnew.onrender.com/adv/auth/profile/update",
        { name: nameValue },
        { withCredentials: true }
      );
      setSnack({
      ...
      setSnack({
        open: true,
        message:
          err.response?.data?.message || err.message || "Could not update name",
        type: "error",
      });
    } finally {
            ...
            >
              <Paper
                ...
                sx={{
                  ...
                  boxShadow:
                    "0 20px 50px rgba(0,0,100,0.08), 0 0 0 1px rgba(0,0,0,0.02)",
                  display: "flex",
              ...
              >
                ...
                >
                    ...
                    <ListItemText
                      ...
                      secondary={
                        <Box
                          ...
                          color="#059669"
                        >
                          {`₹${(profile?.wallet || 0).toLocaleString(
                            undefined,
                            {
                  ...
                  <ListItem
                    sx={{ py: 2, px: 2, bgcolor: "#f8fafc", borderRadius: 2 }}
                  >
                    <ListItemIcon sx={{ minWidth: 46 }}>
                      ...
                      <Button
                        ...
                        sx={{
                          ...
                          "&:hover": {
                            ...
                            background:
                              "linear-gradient(45deg, #4338ca 0%, #6d28d9 100%)",
                          },
                        }}
